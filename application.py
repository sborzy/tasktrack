...
def review():
    ...
    # output format
    return render_template("review.html", reviewTask=reviewTask, today=currentTime.strftime("%m/%d/%Y"), weekAgo = beginWeek.strftime("%m/%d/%Y"), totalTime=round(totalTime,2), averageRate=round(averageRate,2))
